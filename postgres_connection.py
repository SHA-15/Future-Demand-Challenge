...
#-----------------------CONCATENATE DATAFRAMES AND EXPORT TO POSTGRESQL--------------------
...
title_df.insert(0, "event_id", range(1000, 1000 + len(title_df)))
print(title_df)

event_df = pd.concat([title_df, date_time_df], axis=1)
#event_df.to_csv(r"C:\Users\Izrum\Desktop\Checking.csv")
print(event_df)

#-----------------------Creating the Performer and Works DATAFRAME-----------------------



#engine = create_engine("postgresql://postgres:abcd1234@localhost:5432/FutureDemand")
#concatenate_df.to_sql("eventss", engine)
